    ...
    public class LensofPathosEntry : EncycloradiaEntry
    {
        ...
        public override void PageAssembly()
        {
            ...
            { 
                ...
                new CustomTextSnippet("Lens of Pathos", CommonColors.ContextColor, CommonColors.ContextColorDark),
                new CustomTextSnippet("is similar to an ordinary Flareglass lens, but with a clearer composure to loosen the restrictions on what may pass through.", Color.White, Color.Black),
                new CustomTextSnippet("By using a fired", CommonColors.ContextColor, CommonColors.ContextColorDark),
                RadianceUtils.radianceSnippet,
                ...
                new CustomTextSnippet("to hold the contents, and the concentrated ephemeral essence of emotions to fill said vessel. NEWLINE NEWLINE The vessel required is something that can actually feel emotion, but is weak enough to have its life force dragged from its body in order to act as the container. One type of creature fits this perfectly: Critters. NEWLINE NEWLINE By hovering over the Transmutator while a", Color.White, Color.Black),
                new CustomTextSnippet("Lens of Pathos", CommonColors.ContextColor, CommonColors.ContextColorDark),
                new CustomTextSnippet("is inserted into a Projector below will reveal the radius in which an alive full-sized critter (bunnies, squirrels, and birds) will be slain when the crafting process begins in order to supply its life as a vessel for emotions. NEWLINE NEWLINE The next situation to figure out is how to get the emotional essence required in the first place. NEWLINE NEWLINE However, this issue is already solvable with your current knowledge. NEWLINE NEWLINE", Color.White, Color.Black),
                ...
                RadianceUtils.radianceSnippet,
                new CustomTextSnippet("fired from the Projector will absorb the emotions from the vapor and carry them into the object upon Transmutation, opening the door for many new objects to be created that required this additional substance. NEWLINE NEWLINE The emotions carried by potions are less varied than you may think, and are divided into four color categories based on what is given. NEWLINE NEWLINE", Color.White, Color.Black),
                new CustomTextSnippet("Scarlet", CommonColors.ScarletColor, CommonColors.ScarletColorDark),
                new CustomTextSnippet("emotions involve desires of delivering harm unto, or reducing harm from, other creatures. NEWLINE NEWLINE", Color.White, Color.Black),
                new CustomTextSnippet("Cerulean", CommonColors.CeruleanColor, CommonColors.CeruleanColorDark),
                new CustomTextSnippet("emotions are associated with calmness, creativity, and vitality. NEWLINE NEWLINE", Color.White, Color.Black),
                new CustomTextSnippet("Verdant", CommonColors.VerdantColor, CommonColors.VerdantColorDark),
                new CustomTextSnippet("emotions are those related to cognitive abilities and insightfulness. NEWLINE NEWLINE Lastly,", Color.White, Color.Black),
                new CustomTextSnippet("Mauve", CommonColors.MauveColor, CommonColors.MauveColorDark),
                new CustomTextSnippet("emotions are based around pride and the ego from posessing abilities that others do not. NEWLINE NEWLINE You can view what potion effect is aligned with what color by viewing the color of the timer above a Transmutator that is actively dispersing a potion, or by creating an", Color.White, Color.Black),
                new CustomTextSnippet("Alchemical Lens", CommonColors.ContextColor, CommonColors.ContextColorDark),
                new CustomTextSnippet("to conveniently view the color aligned to a potion without the need to consume it. NEWLINE NEWLINE Each recipe involving the", Color.White, Color.Black),
                new CustomTextSnippet("Lens of Pathos", CommonColors.ContextColor, CommonColors.ContextColorDark),
