    ...
    public class GlowstalkEntry : EncycloradiaEntry
    {
        public GlowstalkEntry()
        {
            ...
            AddToEntry(this, new TextPage()
            {
                ...
                @"There exists, however, another way of creating \y Radiance, \r through the use of \b Glowstalkes \r — unique herbs that grow naturally at extremely high elevations atop \b unnatural floating landmasses. \r | " +
                ...
                @"Like all other usual herbs, \b Glowstalkes \r have their own seeds that drop when they are blooming, which may be planted on grass, pots, or Planter Boxes. | " +
