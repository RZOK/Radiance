        ...
        public override void AI()
        {
            if(!spawnedDust)
            {
                for (int h = 0; h < 30; h++)
                {
                    ...
                    WorldParticleSystem.system.AddParticle(new Sprinkle(position, velocity, Main.rand.Next(60, 100), 0, new Color(100, Main.rand.Next(100, 170), Main.rand.Next(150, 255)), Main.rand.NextFloat(0.7f, 1f)));
                }
                spawnedDust = true;
            }
