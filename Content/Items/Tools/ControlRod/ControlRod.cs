...
namespace Radiance.Content.Items.Tools.ControlRod
{
    public class ControlRod : ModItem
    {
        ...
        {
            adjustedRotation = rotation + (float)MathUtils.sineTiming(sideBaubleSpeed) / 5;
    ...
    public class ControlRodProjectile : ModProjectile
    {
        ...
        {
            rotation = Projectile.rotation += (float)MathUtils.sineTiming(sideBaubleSpeed) / 5;
            ...
            Lighting.AddLight(Projectile.Center + Projectile.velocity / (1.5f + ((float)MathUtils.sineTiming(centerBaubleSpeed) / 8)), 0.1f, 0.15f, 0.15f);
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            RadianceDrawing.DrawSoftGlow(Projectile.Center + Projectile.velocity / (1.5f + ((float)MathUtils.sineTiming(centerBaubleSpeed) / 8)), new Color(0, 255, 255, 20), 0.25f, Main.GameViewMatrix.ZoomMatrix); //center bauble
  
            Main.spriteBatch.Draw(RodBaubleCenterTex, Projectile.Center + Projectile.velocity / (1.5f + ((float)MathUtils.sineTiming(40) / 8)) - Main.screenPosition, null, lightColor, Projectile.rotation, RodBaubleCenterTex.Size() / 2, 1, SpriteEffects.None, 0);
