...
namespace Radiance.Content.Items.Armor
{
    ...
    public class LightfootSaboton : ModItem
    {
        ...
        private void SpawnParticlesAtFeet(Player player, Vector2 position)
        {
            ...
            //    ParticleSystem.AddParticle(new SpeedLine(position, Vector2.UnitX * player.velocity.X, 20, 0, new Color(200, 180, 100), (Vector2.UnitX * player.velocity.X).ToRotation(), 20, player));
        }
