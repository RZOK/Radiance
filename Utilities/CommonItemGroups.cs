...
namespace Radiance.Utilities
{
    ...
    {
        public static readonly int[] Woods = [ItemID.Wood, ItemID.RichMahogany, ItemID.Ebonwood, ItemID.Shadewood, ItemID.Pearlwood, ItemID.BorealWood, ItemID.PalmWood, ItemID.DynastyWood, ItemID.SpookyWood, ItemID.AshWood];
