...
namespace Radiance.Utilities
{
    public static partial class RadianceUtils
    {
        ...
        public static void SetRadianceFromContainer(this IInterfaceableRadianceCell obj)
        {
        ...
        public static void DrawFakeItemHover(SpriteBatch spriteBatch, string[] strings, Texture2D tooltipBGTex, Color? color = null) //todo: make this not shit
        {
            if (!color.HasValue)
            ...
            if (Main.SettingsEnabled_OpaqueBoxBehindTooltips)
            {
                RadianceDrawing.DrawInventoryBackground(spriteBatch, tooltipBGTex, (int)pos.X - 14, (int)pos.Y - 10, (int)boxWidth + 6, (int)boxHeight + 28, color.Value);
            }
            foreach (string str in strings)
            {
