...
namespace Radiance.Core.Encycloradia.Entries
{
    public class TitleEntry : EncycloradiaEntry
    {
        ...
        public override void PageAssembly()
        {
            ...
            {
                text = new CustomTextSnippet[] { new CustomTextSnippet("One One One One One One One One One One One One One One One ", new Color(255, 0, 103), new Color(85, 0, 34)),
                new CustomTextSnippet("Two Two Two Two Two Two Two Two Two Two Two Two Two Two Two Two Two Two Two Two Two Two ", new Color(103, 255, 0), new Color(34, 85, 0)),
